      ...
      if (jobs) {
        jobs.forEach(function(job) {
          if (job.last_sms_time && !job.pending) {
            ...
            // Uncomment the following to only wait x minutes instead of x hours for debugging.
            // var waitTimeAsMinutes = job.frequency * 60
            // waitTimeInSeconds = waitTimeAsMinutes;
            var now = new Date();
